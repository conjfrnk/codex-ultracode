...
The release process also verifies reproducible packaging, isolated installation, active installation, and archive contents. See [`RELEASE_REPORT.md`](RELEASE_REPORT.md) for the measured `0.173.1` result.
